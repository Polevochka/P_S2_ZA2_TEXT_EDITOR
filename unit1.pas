...
begin
  ...
  // Теперь нужно к каждой строке добавить средние баллы
  // Просто вызываем Пункт меню, что написали выше {Добавить средние баллы}
  //self - системная переменная - говорит кто вызывают ту или иную функцию формы
  MenuItem9Click(self);
end;
